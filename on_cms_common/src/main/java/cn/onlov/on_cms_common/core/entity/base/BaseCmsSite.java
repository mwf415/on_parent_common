...
public abstract class BaseCmsSite  implements Serializable {
	...
	private java.util.Set<CmsSiteAccessCount> accessCounts;
	private java.util.Set<CmsSiteAccess> accesses;
	private java.util.Set<CmsSiteAccessPages> accessPages;
	private java.util.Set<CmsSiteAccessStatistic> accessStatistics;
	...
	public java.util.Set<CmsSiteAccessCount> getAccessCounts() {
		return accessCounts;
	}

	public void setAccessCounts(
			java.util.Set<CmsSiteAccessCount> accessCounts) {
		this.accessCounts = accessCounts;
	}

	public java.util.Set<CmsSiteAccess> getAccesses() {
		return accesses;
	}

	public void setAccesses(
			java.util.Set<CmsSiteAccess> accesses) {
		this.accesses = accesses;
	}

	public java.util.Set<CmsSiteAccessPages> getAccessPages() {
		return accessPages;
	}

	public void setAccessPages(
			java.util.Set<CmsSiteAccessPages> accessPages) {
		this.accessPages = accessPages;
	}

	public java.util.Set<CmsSiteAccessStatistic> getAccessStatistics() {
		return accessStatistics;
	}

	public void setAccessStatistics(
			java.util.Set<CmsSiteAccessStatistic> accessStatistics) {
