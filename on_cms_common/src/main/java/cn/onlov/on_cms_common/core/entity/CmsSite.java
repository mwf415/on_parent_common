...
import cn.onlov.on_cms_common.core.entity.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	public String getMobileTplIndexOrDef() {
		...
		t.append(Constants.TPLDIR_INDEX).append("/");
		t.append(Constants.TPLDIR_INDEX);
	...
	private String getTplIndexDefault() {
		StringBuilder t = new StringBuilder();
		t.append(getTplIndexPrefix(Constants.TPLDIR_INDEX));
		t.append(Constants.TPL_SUFFIX);
		return t.toString();
	}
	...
	public String getUrl() {
		...
		if (getStaticIndex()) {
			...
			url.append(cn.onlov.on_cms_common.common.web.Constants.SPT).append(cn.onlov.on_cms_common.common.web.Constants.INDEX).append(getStaticSuffix());
		} else {
	...
	public String getAdminUrl() {
		StringBuilder url = new StringBuilder();
		url.append(getUrlDynamic());
		url.append(cn.onlov.on_cms_common.common.web.Constants.ADMIN_SUFFIX);
		return url.toString();
	}
	...
	public String getTplPath() {
		return Constants.TPL_BASE + "/" + getPath();
	}
	...
	public String getSolutionPath() {
		return Constants.TPL_BASE + "/" + getPath() + "/" + getTplSolution();
	}

	public String getMobileSolutionPath() {
		return Constants.TPL_BASE + "/" + getPath() + "/" + getTplMobileSolution();
	}
	...
	public String getResPath() {
		return Constants.RES_PATH + "/" + getPath();
	}
	...
	public String getLibraryPath() {
		return Constants.LIBRARY_PATH + getPath();
	}
	...
	public String getWxAppkey() {
		String wxAppkey = getAttr().get(cn.onlov.on_cms_common.core.Constants.WEIXIN_APPKEY);
		return wxAppkey;
	}

	public String getWxAppSecret() {
		String wxAppSecret = getAttr().get(cn.onlov.on_cms_common.core.Constants.WEIXIN_APPSECRET);
		return wxAppSecret;
	}

	public String getWxToken() {
		String wxToken = getAttr().get(cn.onlov.on_cms_common.core.Constants.WEIXIN_TOKEN);
		return wxToken;
	}
	 ...
	 */
	public CmsSite(Integer id, CmsConfig config, String domain,
