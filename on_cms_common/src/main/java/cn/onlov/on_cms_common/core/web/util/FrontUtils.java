package cn.onlov.on_cms_common.core.web.util;

import cn.onlov.on_cms_common.cms.Constants;
import cn.onlov.on_cms_common.common.web.ProcessTimeFilter;
...
public class FrontUtils {
	...
	public static String showMessage(HttpServletRequest request,
		...
		CmsSite site = CmsUtils.getSite(request);
		frontData(request, model, site);
		model.put(cn.onlov.on_cms_common.common.web.Constants.MESSAGE, message);
		if (args != null) {
			model.put(ARGS, args);
		}
