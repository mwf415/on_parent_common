...
public class CmsWorkLoadStatisticSvcImpl implements CmsWorkLoadStatisticSvc {
	...
	private String format(int time) {
		...
		String begin, end;
		begin = DateFormatUtils.format(calendar.getTime(), CmsStatistic.TIMEPATTERN);
		calendar.add(HOUR_OF_DAY, 1);
		end = DateFormatUtils.format(calendar.getTime(), CmsStatistic.TIMEPATTERN);
		return begin + CmsStatistic.JOIN + end;
	}
