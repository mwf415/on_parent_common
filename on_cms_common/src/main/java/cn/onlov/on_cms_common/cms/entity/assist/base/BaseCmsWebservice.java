...
import cn.onlov.on_cms_common.cms.entity.assist.CmsWebserviceParam;
...
public abstract class BaseCmsWebservice  implements Serializable {
	...
	// collections
	private java.util.List<CmsWebserviceParam> params;
	 ...
	 */
	public java.util.List<CmsWebserviceParam> getParams () {
		return params;
	}
	 ...
	 */
	public void setParams (java.util.List<CmsWebserviceParam> params) {
		this.params = params;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CmsWebservice)) return false;
		else {
			CmsWebservice cmsWebservice = (CmsWebservice) obj;
