...
import cn.onlov.on_cms_common.common.upload.FileUpload;
...
public class WeiXinSvcImpl implements WeiXinSvc {
	...
	public Map<String, String> getToken() {
		...
		if(site!=null){
			appid=site.getAttr().get(cn.onlov.on_cms_common.core.Constants.WEIXIN_APPKEY);
			secret=site.getAttr().get(cn.onlov.on_cms_common.core.Constants.WEIXIN_APPSECRET);
		}
