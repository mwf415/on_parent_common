...
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_SOURCE;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_TARGET_ALL;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_ENGINE;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_LINK;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_KEYWORD;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_AREA;

import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_TARGET_IP;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_TARGET_PV;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_TARGET_VISITORS;
import static cn.onlov.on_cms_common.cms.entity.assist.CmsSiteAccessStatistic.STATISTIC_TARGET_VISITSECOND;
...
public class CmsSiteAccessDaoImpl extends
	...
	public List<Object[]> statisticTodayByTarget(Integer siteId,Integer target,String statisticColumn,String statisticValue){
		...
		if(target==STATISTIC_TARGET_PV){
			...
			hql="select sum(bean.visitPageCount)as pv,count(distinct bean.ip)as ip,"
					+ "count(distinct bean.sessionId)as visitors,avg(bean.visitSecond) as second,"
					+ " hour(bean.accessTime)  as m";
		}
