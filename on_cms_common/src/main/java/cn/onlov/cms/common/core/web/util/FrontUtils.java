package cn.onlov.cms.common.core.web.util;
...
public class FrontUtils {
	...
	public static String showMessage(HttpServletRequest request,
		...
		CmsSite site = CmsUtils.getSite(request);
		frontData(request, model, site);
		model.put(cn.onlov.cms.common.common.web.Constants.MESSAGE, message);
		if (args != null) {
			model.put(ARGS, args);
		}
	...
	public static void includePagination(CmsSite site,
		...
		if (!StringUtils.isBlank(sysPage)) {
			...
			env.include(tpl, cn.onlov.cms.common.common.web.Constants.UTF8, true);
