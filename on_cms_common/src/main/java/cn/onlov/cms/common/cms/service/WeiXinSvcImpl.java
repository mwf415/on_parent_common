...
import cn.onlov.cms.common.common.upload.FileUpload;
...
public class WeiXinSvcImpl implements WeiXinSvc {
	...
	public Map<String, String> getToken() {
		...
		if(site!=null){
			appid=site.getAttr().get(cn.onlov.cms.common.core.Constants.WEIXIN_APPKEY);
			secret=site.getAttr().get(cn.onlov.cms.common.core.Constants.WEIXIN_APPSECRET);
		}
