...
public abstract class BaseCmsScoreGroup  implements Serializable {
	...
	// collections
	private java.util.Set<CmsScoreItem> items;
	 ...
	 */
	public java.util.Set<CmsScoreItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<CmsScoreItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CmsScoreGroup)) return false;
		else {
			CmsScoreGroup cmsScoreGroup = (CmsScoreGroup) obj;
