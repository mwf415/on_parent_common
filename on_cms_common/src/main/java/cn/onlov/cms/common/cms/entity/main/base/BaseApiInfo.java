...
public abstract class BaseApiInfo  implements Serializable {
	...
	// collections
	private java.util.Set<ApiRecord> callRecords;
	 ...
	 */
	public java.util.Set<ApiRecord> getCallRecords () {
		return callRecords;
	}
	 ...
	 */
	public void setCallRecords (java.util.Set<ApiRecord> callRecords) {
