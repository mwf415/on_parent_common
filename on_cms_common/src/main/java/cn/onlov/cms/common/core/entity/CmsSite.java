...
import cn.onlov.cms.common.core.entity.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	public String getUrl() {
		...
		if (getStaticIndex()) {
			...
			url.append(cn.onlov.cms.common.common.web.Constants.SPT).append(cn.onlov.cms.common.common.web.Constants.INDEX).append(getStaticSuffix());
		} else {
	...
	public String getAdminUrl() {
		StringBuilder url = new StringBuilder();
		url.append(getUrlDynamic());
		url.append(cn.onlov.cms.common.common.web.Constants.ADMIN_SUFFIX);
		return url.toString();
	}
	...
	public String getWxAppkey() {
		String wxAppkey = getAttr().get(cn.onlov.cms.common.core.Constants.WEIXIN_APPKEY);
		return wxAppkey;
	}

	public String getWxAppSecret() {
		String wxAppSecret = getAttr().get(cn.onlov.cms.common.core.Constants.WEIXIN_APPSECRET);
		return wxAppSecret;
	}

	public String getWxToken() {
		String wxToken = getAttr().get(cn.onlov.cms.common.core.Constants.WEIXIN_TOKEN);
		return wxToken;
	}
