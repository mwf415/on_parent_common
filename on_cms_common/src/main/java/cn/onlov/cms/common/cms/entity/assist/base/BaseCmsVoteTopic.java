...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	private java.util.Set<CmsVoteSubTopic> subtopics;
	private java.util.Set<CmsVoteRecord> records;
	...
	public java.util.Set<CmsVoteSubTopic> getSubtopics() {
		return subtopics;
	}

	public void setSubtopics(
			java.util.Set<CmsVoteSubTopic> subtopics) {
		this.subtopics = subtopics;
	}

	public java.util.Set<CmsVoteRecord> getRecords() {
		return records;
	}

	public void setRecords(
			java.util.Set<CmsVoteRecord> records) {
