...
public abstract class BaseCmsGroup  implements Serializable {
	...
	// collections
	private java.util.Set<Channel> viewChannels;
	private java.util.Set<Channel> contriChannels;
	 ...
	 */
	public java.util.Set<Channel> getViewChannels () {
		return viewChannels;
	}
	 ...
	 */
	public void setViewChannels (java.util.Set<Channel> viewChannels) {
	 ...
	 */
	public java.util.Set<Channel> getContriChannels () {
	 ...
	 */
	public void setContriChannels (java.util.Set<Channel> contriChannels) {
