...
import cn.onlov.cms.common.core.dao.DbTplDao;
import cn.onlov.cms.common.core.entity.DbTpl;
import cn.onlov.cms.common.core.tpl.ParentDirIsFileExceptioin;
...
public class DbTplMngImpl implements TemplateLoader, TplManager {
	...
	public void save(String path, MultipartFile file) {
		String name = path + Constants.SPT + file.getOriginalFilename();
		try {
			String source = new String(file.getBytes(), Constants.UTF8);
